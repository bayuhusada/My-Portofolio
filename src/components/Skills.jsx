...
const Skills = () => {
  ...
  const skills = ['HTML', 'CSS', 'JavaScript', 'React', 'Next', 'Figma', 'Git', 'Figma' , 'TailwindCSS', 'Bootsrap', 'PHP', 'MySQL', 'RestAPI', 'Linux']
  ...
  return (
    <section id="skills" className="py-20 bg-white" ref={skillsRef}>
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-5 md:grid-cols- gap-6">
